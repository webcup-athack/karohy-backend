...
var Admin = require('../../src/model/admin.model');
var ERROR = require('../../src/error/Error').ERROR;
var bcrypt_1 = __importDefault(require("bcrypt"));
var authenticateAdmin = require('../../src/service/admin.service').authenticateAdmin;
                ...
                try {
                    bcrypt_1.default.hash(testMdp, 10, function (err, hashed) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    admin = new Admin(__assign(__assign({}, userTest), { motDePasse: hashed }));
        ...
        it('should authenticate an admin with valid email and password', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, authenticateAdmin(testEmail, testMdp)];
                    case 1:
                        user = _a.sent();
        ...
        it('should throw GeneralException with ERROR_INVALID_EMAIL for invalid email', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, authenticateAdmin(invalidEmail, password)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
        ...
        it('should throw GeneralException with ERROR_INVALID_PASSWORD for empty password', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, authenticateAdmin(email, emptyPassword)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
        ...
        it('should throw GeneralException with ERROR_INVALID_CREDENTIALS for invalid credentials', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, authenticateAdmin(invalidUser.email, invalidUser.motDePasse)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
        ...
        after(function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, Admin.deleteOne({ nom: userTest.nom })];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
